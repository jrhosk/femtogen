...
a1_ep = tf.constant(-.24, dtype=tf.float64)
a1_mp = tf.constant(.12, dtype=tf.float64)
a1_mn = tf.constant(2.33, dtype=tf.float64)

b1_ep = tf.constant(10.98, dtype=tf.float64)
b1_mp = tf.constant(10.97, dtype=tf.float64)
b1_mn = tf.constant(14.72, dtype=tf.float64)

b2_ep = tf.constant(12.82, dtype=tf.float64)
b2_mp = tf.constant(18.86, dtype=tf.float64)
b2_mn = tf.constant(24.20, dtype=tf.float64)

b3_ep = tf.constant(.12, dtype=tf.float64)
b3_mp = tf.constant(6.55, dtype=tf.float64)
b3_mn = tf.constant(84.1, dtype=tf.float64)

ea1ep = tf.constant(.12, dtype=tf.float64)
ea1mp = tf.constant(.04, dtype=tf.float64)
ea1mn = tf.constant(1.4, dtype=tf.float64)

eb1ep = tf.constant(.19, dtype=tf.float64)
eb1mp = tf.constant(.11, dtype=tf.float64)
eb1mn = tf.constant(1.7, dtype=tf.float64)

eb2ep = tf.constant(1.10, dtype=tf.float64)
eb2mp = tf.constant(.28, dtype=tf.float64)
eb2mn = tf.constant(9.8, dtype=tf.float64)

eb3ep = tf.constant(6.8, dtype=tf.float64)
eb3mp = tf.constant(1.2, dtype=tf.float64)
eb3mn = tf.constant(41.0, dtype=tf.float64)

aa = tf.constant(1.7, dtype=tf.float64)
bb = tf.constant(3.3, dtype=tf.float64)
eaa = tf.constant(.04, dtype=tf.float64)
ebb = tf.constant(.32, dtype=tf.float64)

amp = tf.constant(.9383, dtype=tf.float64)
amup = tf.constant(2.79, dtype=tf.float64)
amun = tf.constant(-1.91, dtype=tf.float64)
